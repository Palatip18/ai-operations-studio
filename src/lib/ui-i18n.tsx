...
export const uiCopy = {
  en: {
    ...
    documentsFictional: "Choose a topic or enter a request to begin.",
    ...
    supportIntro:
      "Handles online-gaming questions about deposits, withdrawals, games, and promotions, while routing missing-funds and high-risk cases for specialist review.",
    supportLimit:
    ...
    fictional: "Choose a topic below or enter the customer's question.",
    ...
    language: "Language",
    scenarios: [
      ["Deposit missing", "My deposit DEP-1002 was completed, but the credit has not arrived."],
      ["Withdrawal delayed", "My withdrawal WDL-2001 has been pending for a long time."],
      ["Withdrawal missing", "Withdrawal WDL-2002 says completed, but the money has not reached my account."],
      ...
      ["Promotion status", "Is the Weekend Reward open now, how do I claim it, and where will the bonus appear?"],
      ["Offer unavailable", "The limited offer is open, but I still cannot claim it after trying once. What happens next?"],
    ],
    sourceCatalog: "Source catalog",
    ofWord: "of",
    emptySearch: "Run a query to search the knowledge base and retrieve a grounded, cited answer.",
    ...
    retry: "Retry",
    mobileCatalogNote: "On mobile, the source catalog collapses into an accordion above the answer panel so the answer remains easy to reach.",
    ...
    handoffCreated: "Review case created",
  ...
  th: {
    ...
    documentsFictional: "เลือกหัวข้อหรือพิมพ์คำขอเพื่อเริ่มใช้งาน",
    ...
    supportIntro:
      "ตอบคำถามเกี่ยวกับฝากเงิน ถอนเงิน ปัญหาเกม และโปรโมชั่น พร้อมส่งเคสเงินไม่เข้าและเคสเสี่ยงให้ทีมที่เกี่ยวข้องตรวจสอบ",
    supportLimit:
    ...
    fictional: "เลือกหัวข้อด้านล่างหรือพิมพ์คำถามของลูกค้า",
    ...
    language: "ภาษา",
    scenarios: [
      ["ฝากเงินไม่เข้า", "ฝากเงินรายการ DEP-1002 สำเร็จแล้ว แต่เครดิตยังไม่เข้า"],
      ["ถอนเงินล่าช้า", "ถอนเงินรายการ WDL-2001 นานมาก สถานะยังอยู่ระหว่างดำเนินการ"],
      ["ถอนแล้วเงินไม่เข้า", "รายการ WDL-2002 แสดงว่าถอนเงินสำเร็จแล้ว แต่เงินยังไม่เข้าบัญชี"],
      ...
      ["ตรวจสถานะโปร", "โปร Weekend Reward เปิดอยู่ไหม ต้องกดรับที่ไหน และโบนัสจะเข้าในส่วนใด"],
      ["ยังรับโปรไม่ได้", "โปรที่มีจำนวนจำกัดยังเปิดอยู่ แต่ลองรับหนึ่งครั้งแล้วยังไม่ได้ ต้องทำอย่างไรต่อ"],
    ],
    sourceCatalog: "รายการเอกสาร",
    ofWord: "จาก",
    emptySearch: "พิมพ์คำค้นหาเพื่อค้นหาจากฐานความรู้สมมติและรับคำตอบที่มีหลักฐานอ้างอิง",
    ...
    handoffCreated: "สร้างเคสตรวจสอบแล้ว",
    simulated: "สภาพแวดล้อมทดสอบ",
    handoffStatus: "สถานะ",
  ...
  zh: {
    ...
    empty: "请选择示例或输入问题。",
    documentsFictional: "请选择主题或输入请求以开始。",
    reviewing: "正在审核请求…",
    traceLink: "查看来源和技术轨迹",
    ...
    supportIntro:
      "处理在线游戏存款、提款、游戏故障与促销问题，并将资金未到账及高风险事件转交相关团队审核。",
    supportLimit:
      "这是受控试点目标，不是生产保证。复杂、敏感、有争议或高风险事件仍由人工客服处理。",
    supportEmpty: "请选择示例或输入客服问题。",
    fictional: "请选择下方主题或输入客户问题。",
    ...
    language: "语言",
    scenarios: [
      ["存款未到账", "存款 DEP-1002 已完成，但游戏账户余额还没有增加。"],
      ["提款延迟", "提款 WDL-2001 长时间处于处理中。"],
      ["提款未到账", "提款 WDL-2002 显示已完成，但银行账户还没收到钱。"],
      ["游戏故障", "游戏卡住且余额没有更新，需要提供哪些信息？"],
      ["促销详情", "新会员促销有哪些条件？"],
      ["奖金提款", "领取奖金后暂时无法提款，我应该检查什么？"],
      ["异常交易", "游戏账户中出现了一笔不是我操作的交易。"],
      ["负责任使用", "我担心花费过多，平台应提供哪些控制工具？"],
      ["查询促销状态", "Weekend Reward 促销现在开放吗？在哪里领取，奖金会进入哪里？"],
      ["仍无法领取", "限量促销仍显示开放，但尝试一次后仍无法领取，下一步怎么办？"],
    ],
    sourceCatalog: "源文档目录",
    ofWord: "的",
    emptySearch: "运行查询以检索知识库并获取有依据且引用的回答。",
